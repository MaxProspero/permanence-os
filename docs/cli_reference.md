...
- Endpoints: `/health`, `/auth/session`, `/onboarding/start`, `/memory/schema`, `/memory/entry`, `/app/ophtxn`, `/ops/summary`
- App shell route: open `http://127.0.0.1:8797/app/ophtxn` after starting `foundation-api`
